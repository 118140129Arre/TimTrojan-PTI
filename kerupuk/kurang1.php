...
<meta name="theme-color" content="#ffffff">
    ...
    <form action="../kerupuk/inputankeluar.php" method="POST" name="form-input-data">
                ...
                <div class="input-group input-group-sm mb-3">
                    ...
                    <input required type="text" name="id_kerupuk" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value="<?php echo $kd ?>" readonly>
                </div>
                ...
                <div class="input-group input-group-sm mb-3">
                    ...
                    <input required type="text" name="jenis_kerupuk" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value="<?php echo $jk ?>" readonly>
                </div>
...
<form action="" method="post">
    <table border="4" width="370px" class="table table-bordered border-primary table-responsive-sm table-sm">
        <thead><tr >
            <th class="ukf">No</th>
            <th class="ukf">Inp</th>
